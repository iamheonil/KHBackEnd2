...
<script type="text/javascript">
	...
	function appendRequest() {
		console.log("appendRequest called");
		...
		// getElementsByTagName("tagname") 을 사용해야한다
		...
		//record태그 객체 얻기 - 배열로 반환
		var record = member[0].getElementsByTagName("record");
		console.log(record[0]);

		//name 태그 content태그 객체 얻기 - 배열로 반환
		...
		main.innerHTML += "<div>" + nameData + ", " + contentData + "</div>";
	}
